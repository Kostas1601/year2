        ...
        <div id="main_container">
            ...
            <div id="main_content">
                ...
                <div class="center_content">
                    ...
                    <div class="center_title_bar">Results</div>
                    ...
                    <%
                                ...
                                try {
                                    if (request.getParameter("normsearch") != null) {
                                        String searchInput = request.getParameter("normsearch");
                                        Connection conn = DriverManager.getConnection("jdbc:odbc:JDBC-ODBC", "p3090148", "16011991");
                                        Statement stmt = conn.createStatement();
                                        ResultSet rs;

                                        rs = stmt.executeQuery("SELECT * FROM PRODUCTS where NAME LIKE '" + searchInput + "%' OR NAME LIKE '%" + searchInput + "'");
                                        //  out.println("SELECT * FROM PRODUCTS where NAME LIKE '" + searchInput + "%'");
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.println("<div class=\"product_img_big\">");
                                            out.println("<img src=\"images/" + img + "\" width=\"165\" height=\"113\" alt=\"\" title=\"\" border=\"0\" /></div>");
                                            out.println("<div class=\"details_big_box\">");
                                            out.println("<div class=\"product_title_big\"><a href=\"SpecificItem.jsp?name=" + title + "&price=" + price + "&producer=" + producer+ "&prid=" + prid + "&rating=" + rating + "&description=" + desc + "&seller=" + seller + "&img1=" + img + "&img2=" + img2 + "&img3=" + img3 + "&quantity=" + quantity + "\">" + title + "</a></div>");
                                            out.println("<div class=\"specifications\"></div>");
                                            out.println("<div class=\"prod_price_big\"><span class=\"price\">" + price + "$</span></div>");
                                            out.println("</div>");
                                            out.println("</div>");
                                        ...
                                        String searchInput = request.getParameter("advancedsearch");
                                        String Category = request.getParameter("category");
                                        Connection conn = DriverManager.getConnection("jdbc:odbc:JDBC-ODBC", "p3090148", "16011991");
                                        Statement stmt = conn.createStatement();
                                        ResultSet rs;

                                        rs = stmt.executeQuery("SELECT * FROM PRODUCTS where NAME LIKE '" + searchInput + "%' OR NAME LIKE '%" + searchInput + "' AND CATEGORY= '" + Category + "'");
                                       // out.println("SELECT * FROM PRODUCTS where NAME LIKE '" + searchInput + "%' OR NAME LIKE '%" + searchInput + "' AND CATEGORY= '" + Category + "'");
            ...
            <div class="footer">
                ...
                <div class="center_footer">
                    Team Neilon. All Rights Reserved 2011<br />
