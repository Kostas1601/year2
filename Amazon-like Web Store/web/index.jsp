                ...
                <div class="center_content">
                    <%
                                ...
                                try {
                                    ...
                                    while (rs.next()) {
                                        ...
                                        String cutdesc = desc;
                                        if(desc.length() >= 200){
                                            cutdesc = cutdesc.substring(0, 200);
                                        }
                                        out.println("<div class=\"oferta\">");
                                        out.println("<img src=\"images/" + img + "\" width=\"165\" height=\"113\" border=\"0\" class=\"oferta_img\" alt=\"\" title=\"\" />"
                                                + "<div class=\"oferta_details\">"
                                                + " <div class=\"oferta_title\">" + title + "</div>");
                                        out.println("<div class=\"oferta_text\">"
                                                + "" + cutdesc + ""
                                                + " </div>"
                                                + "<a href=\"SpecificItem.jsp?name=" + title + "&price=" + price + "&producer=" + producer + "&prid=" + prid + "&rating=" + rating + "&description=" + desc + "&seller=" + seller + "&img1=" + img + "&img2=" + img2 + "&img3=" + img3 + "&quantity=" + quantity + "\" class=\"prod_buy\">details</a>"
                                                + " </div>"
                                                + "</div>");
                    ...
                    <%  try {
                                ...
                                try {
                                    ...
                                    rs = stmt.executeQuery("SELECT TOP 6 * FROM PRODUCTS ORDER BY UPLOADDATE DESC");
                                    while (rs.next()) {
                                        String title = rs.getString("NAME");
                                        String price = rs.getString("PRICE");
                                        String producer = rs.getString("PRODUCER");
                                        ...
                                        if (title.length() >= 25) {
                                            titlez = title.substring(0, 25);
                                        }

                                        out.println("<div class=\"prod_box\">"
                                                + "<div class=\"center_prod_box\">"
                                                + "<div class=\"product_title\"><a href=\"SpecificItem.jsp?name=" + title + "&price=" + price + "&producer=" + producer + "&prid=" + prid + "&rating=" + rating + "&description=" + desc + "&seller=" + seller + "&img1=" + img + "&img2=" + img2 + "&img3=" + img3 + "&quantity=" + quantity + "\">" + titlez + "</a></div>"
                                                ...
                                                + "<a href=\"SpecificItem.jsp?name=" + title + "&price=" + price + "&producer=" + producer + "&prid=" + prid + "&rating=" + rating + "&description=" + desc + "&seller=" + seller + "&img1=" + img + "&img2=" + img2 + "&img3=" + img3 + "&quantity=" + quantity + "\" class=\"prod_details\">Details</a>"
                                                + "</div>"
                                                + "</div>");
                                    }
                    ...
                    <%  try {
                                ...
                                try {
                                    ...
                                    rs = stmt.executeQuery("SELECT TOP 3 * FROM PRODUCTS WHERE RATING = 5 ORDER BY NEWID()");
                                    while (rs.next()) {
                                        String title = rs.getString("NAME");
                                        String price = rs.getString("PRICE");
                                        String producer = rs.getString("PRODUCER");
                                        ...
                                        out.println("<div class=\"prod_box\">"
                                                + "<div class=\"center_prod_box\">"
                                                + "<div class=\"product_title\"><a href=\"SpecificItem.jsp?name=" + title + "&price=" + price + "&producer=" + producer + "&prid=" + prid + "&rating=" + rating + "&description=" + desc + "&seller=" + seller + "&img1=" + img + "&img2=" + img2 + "&img3=" + img3 + "&quantity=" + quantity + "\">" + title + "</a></div>"
                                                + "<div class=\"product_img\"><a href=\"SpecificItem.jsp?name=" + title + "&price=" + price + "&producer=" + producer + "&prid=" + prid + "&rating=" + rating + "&description=" + desc + "&seller=" + seller + "&img1=" + img + "&img2=" + img2 + "&img3=" + img3 + "&quantity=" + quantity + "\"><img src=\"images/" + img + "\" width=\"165\" height=\"113\" alt=\"\" title=\"\" border=\"0\" /></a></div>"
                                                + "<div class=\"prod_price\"><span class=\"price\">" + price + "$</span></div>"
                                                + "</div>"
                                                + "<div class=\"prod_details_tab\">"
