                ...
                <div class="center_content">
                    ...
                    <div class="center_prod_box">
                        <%
                                    ...
                                    out.println("<div class=\"product_title\">" + session.getAttribute("theUserName") + "</div>"
                                            + "<div class=\"product_img\"><img src=\"images/defaultavatar.gif\" alt=\"\" width=\"167\" border=\"0\" title=\"\" /></div>"
                                            + "<a href=\"index.jsp\" class=\"account_button\">Change Avatar</a></div>");
                        %>



                        <a href="NewItem.jsp" class="account_button"><b>+New Item</b></a>
                        <a href="ShowUserHistory.jsp" class="account_button"> History</a>
                        
                        <div class="center_title_bar">My Items</div>
                        <%@ page language="java" import="java.sql.*"%>
                        <%
                                    try {
                                        Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
                                    ...
                                    try {
                                        ...
                                        rs = stmt.executeQuery("SELECT * FROM PRODUCTS where SELLER = '" + user + "'");
