...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <div class="center_title_bar">Advanced Search</div>
		  ...
		  <p>
		    ...
		    <input name="advancedsearch" type="text" class="advsearch_input" value="keyword" size="200"/>
                    <input type="submit" class="prod_details" value="Search"/></input>
                      </form>
	        In Category:
		    <select id="category" name="category">
	          ...
	          <option value="ComputersNetwork">Computers and Networking</option>
