        ...
        <div id="main_container">
            ...
            <div id="main_content">
                ...
                <div class="center_content">
                    ...
                    <div class="center_title_bar">Publish New Item</div>

                    <form method= "POST" action="InsertNewItem.jsp" id="NewItemForm">
                        <div class="form_row">
                            <label class="contact"><strong>ProductName</strong> </label>
                            <input type="text" class="contact_input" name="prname"/>
                        </div>
                        ...
                        <div class="form_row">
                            <label class="contact"><strong>Producer</strong></label>
                            <input type="text" class="contact_input" name="producer"/>
                        </div>
                        <div class="form_row">
                            <label class="contact"><strong>How Many?</strong> </label>
                            <input type="text" class="contact_input" name="quantity"/>
                        </div>
                        <div class="form_row">
                            <label class="contact"><strong>Description </strong></label>
                            <textarea onKeyPress="return taLimit(this)" onKeyUp="return taCount(this,'myCounter')" name="description" rows=7 wrap="physical" cols=40></textarea>
                            <B><SPAN id=myCounter>1000</SPAN></B> characters remaining
                        </div>
                        <div class="form_row">
                            <label class="contact"><strong>Image URL</strong> </label>
                            <input type="text" class="contact_input" name="image1"/>
                        </div>
                        <div class="form_row">
                            <label class="contact"><strong>Image 2 URL(Optional)</strong></label>
                            <input type="text" class="contact_input" name="image2"/>
                        </div>
                        <div class="form_row">
                            <label class="contact"><strong>Image 3 URL(Optional)</strong></label>
                            <input type="text" class="contact_input" name="image3"/>
                        </div>

                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <p><label class="contact"><strong>Category</strong></label>
                    ...
                    <% if (session.getAttribute("Error") == "error") {
                                    out.println("<h3><font color=\"RED\"><i>Please Complete All Required fields</i></font></h3>");
                                }
