        ...
        <div id="main_container">
            ...
            <div id="main_content">
                ...
                <div class="center_content">
                    ...
                    <div class="center_title_bar">Items Purchased</div>
                    ...
                    <%
                                ...
                                try {
                                    ...
                                    rs = stmt.executeQuery("SELECT * FROM HISTORY where BUYER = '" + session.getAttribute("theUserName") + "'");
                                    ...
                                    //    String Buyer = rs.getString("BUYER");
                                        ...
                                        out.println("<div class=\"product_title_big\">" + ProductName + "</a></div>");
                                        out.println("<div class=\"specifications\">"
                                                + "Bought Quantity: <span class=\"blue\">" + OrderQuantity + "</span><br />"
                                                + "Total Paid: <span class=\"blue\">"
                                                + " " + UnitPrice + "</span><br />"
                                ...
                                <div class="center_title_bar">Items Sold</div>
                    ...
                    <%
                                ...
                                try {
                                    ...
                                    rs = stmt.executeQuery("SELECT * FROM HISTORY where SELLERNAME = '" + session.getAttribute("theUserName") + "'");
