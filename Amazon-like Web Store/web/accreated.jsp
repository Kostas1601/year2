        ...
        <div id="main_container">
            ...
            <div id="header">
                ...
                <div class="top_right">
                    ...
                    <div class="big_banner">
                        <a href="index.jsp"><img src="images/banner728.jpg" alt="" title="" border="0" /></a>
                    </div>
            ...
            <div id="main_content">
                ...
                <div class="center_content">
                    ...
                    <div class="center_title_bar">Account Created!!</div>

                    <div class="product_title_big">


                        <div class="product_img"><a href="details.html"><img src="images/arrow.png" alt="" width="74" height="46" border="0" align="right" title="" /></a></div>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <% String firstN = session.getAttribute("FirstName").toString();
                                    String lastN = session.getAttribute("LastName").toString();
                        %>
                        <%out.print("<p>Dear " + firstN + " " + lastN + ", Thank you for joining Neilon</p>");%>
                        <p>&nbsp;</p>
                        <p>Your Neilon Account Has Been Created Successfully!!</p>
                        <p>&nbsp;</p>
                        <p>You can Log-In to your account in the box on the right</p>
                        <p>Don't forget to read the Terms Of Use in order to ensure that we keep Neilon Safe and user friendly for everyone!   </p>
                        <p>&nbsp;</p>
                    </div>
